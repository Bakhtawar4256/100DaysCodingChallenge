...
console.log('Hellen Keller one said,"The best and most beautiful things in the world cannot be seen or even touched - they must be felt with the heart"');
...
let famous_person: string = "Helen Keller";
let message: string = `${famous_person} once said, "Never bend your head. Always hold it high. Look the world straight in the eye"`;
console.log(message);
